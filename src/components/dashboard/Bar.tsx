        ...
        <>
            <aside className={` ${sidebarOpen ? "w-[90px]" : "w-[280px]"} max-lg:hidden  fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-white h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200 -translate-x-full lg:translate-x-0`}>
                <div className='py-8 flex justify-start items-end gap-2'>
                    ...
                    <p className={`${sidebarOpen ? "hidden" : ""} text-3xl text-orange-700 font-bold max-md:text-2xl transition-all duration-300 ease-in-out`}>Platzi Fake</p>
                </div>
                <div className='flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar'>
                    <nav className='mb-6'>
                        <div className='flex flex-col gap-4 overflow-x-hidden'>
                            ...
                            <ul className='flex flex-col gap-4'>
                                <li>
                                    <button className={`${selectPage === "Setting" ? "bg-orange-700 text-white" : "text-black/70 hover:text-orange-700"} ${sidebarOpen ? "justify-center" : ""} px-4 h-[50px] transition-all duration-300 ease-in-out relative flex w-full items-center gap-4 rounded-[10px] font-600 group menu-item-inactive cursor-pointer`}
                                        onClick={() => {
                                ...
                                <li>
                                    <button
                                        className={`${selectPage === "Logout" ? "bg-orange-700 text-white" : "text-black/70 hover:text-orange-700"} ${sidebarOpen ? "justify-center" : ""} px-4 h-[50px] transition-all duration-300 ease-in-out relative flex w-full items-center gap-4 rounded-[10px] font-600 group menu-item-inactive cursor-pointer`}
                                        onClick={onLogout}
                                    >

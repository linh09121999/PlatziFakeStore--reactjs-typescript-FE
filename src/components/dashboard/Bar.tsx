                        ...
                        <div className='flex flex-col gap-4 overflow-x-hidden'>
                            <ul className='flex flex-col gap-4'>
                                {listPagesDashboard.map(page => (
                                    <li key={page.id}>
                                        <button className={`${selectPage === page.title ? "bg-orange-700 text-white" : ""} ${sidebarOpen ? "justify-center" : ""} px-4 h-[50px] transition-all duration-300 ease-in-out relative flex w-full items-center gap-4 rounded-[10px] font-600 group menu-item-inactive cursor-pointer`}
                                            onClick={() => {
